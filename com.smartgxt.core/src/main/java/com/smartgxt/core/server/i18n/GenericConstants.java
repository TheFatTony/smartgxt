 ...
 */
package com.smartgxt.core.server.i18n;
...
public class GenericConstants extends GenericX {
	...
	public GenericConstants(Class<?> _itf, String lang) throws IOException,
	...
	private Object buildConstant(String propertyName, Method method)
		...
		if (resultAsString == null) {
			...
			// Convert string value under the required Type
			return toObject(new String(resultAsString.getBytes("ISO-8859-1"),
					"UTF-8"), method.getReturnType());
		}
	}
	...
	private Object getDefaultValue(Method method) {
		...
		if (returnClass.equals(String.class)) {
			...
			DefaultStringMapValue a = method
			...
			DefaultStringArrayValue a = method
