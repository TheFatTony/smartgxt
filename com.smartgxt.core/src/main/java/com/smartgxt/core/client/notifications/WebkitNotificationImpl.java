package com.smartgxt.core.client.notifications;
...
public class WebkitNotificationImpl {
	...
	private native static void requestPermissionImpl(
		...
		$wnd.webkitNotifications
				.requestPermission($entry(function() {
					_this.@com.smartgxt.core.client.notifications.WebkitNotificationImpl::callbackRequestPermission(Lcom/google/gwt/user/client/rpc/AsyncCallback;)(callback);
				}));
	}-*/;
	...
	public native void show(String hideDelay) /*-{
		var obj = this.@com.smartgxt.core.client.notifications.WebkitNotificationImpl::jsObject;
		var _this = this;
		obj.onclick = function(event) {
			obj.cancel();
			$wnd.focus();
			_this.@com.smartgxt.core.client.notifications.WebkitNotificationImpl::execute()();
		};
		obj.show();
		if (hideDelay != 0)
			setTimeout(function() {
